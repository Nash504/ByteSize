      ...
      <main className="flex flex-col w-full gap-4 p-4">
        <div className="flex flex-col items-start w-full gap-4 mb-4 mt-4">
          ...
          <p className="text-lg text-left">
            ...
            turn topics into smart, bite-sized flashcards for easy learning and
            revision.
            <br />
            <br />
            Built with Next.js, ByteSize is designed for efficiency, ensuring a
            smooth, user-friendly experience. Stay organized, stay
            ahead—ByteSize makes studying smarter, not harder.
          </p>
        </div>
